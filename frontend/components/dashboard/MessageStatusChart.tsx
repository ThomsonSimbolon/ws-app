 ...
 * 
 * Displays message status distribution as a simple bar chart.
...
export default function MessageStatusChart({ data, className = '' }: MessageStatusChartProps) {
  if (!data || data.length === 0) {
    return (
      <Card className={className}>
        <h3 className="text-lg font-semibold text-text-primary mb-4">Message Status</h3>
        <p className="text-text-muted text-sm">No message data available</p>
      </Card>
    );
  }
  ...
  return (
    <Card className={className}>
      <h3 className="text-lg font-semibold text-text-primary mb-4">Message Status Distribution</h3>
